...
VALUES 
    ...
    (3, 'Mike Johnson', '555555555', '789 Oak St'),
    (4, 'Sarah Brown', '777777777', '321 Pine St'),
    (5, 'Alex Green', '888888888', '654 Birch St'),
    (6, 'Emily White', '999999999', '987 Cedar St'),
    (7, 'David Lee', '444444444', '147 Maple St'),
    (8, 'Olivia Taylor', '333333333', '258 Walnut St'),
    (9, 'Ethan Parker', '222222222', '369 Cherry St'),
    (10, 'Lily Martinez', '666666666', '852 Oakwood St'),
    (11, 'Andrew King', '777777777', '963 Elmwood St'),
    (12, 'Grace Adams', '888888888', '741 Pinecrest St'),
    (13, 'Lucas Harris', '999999999', '654 Sunset St');
GO
...
VALUES 
    ...
    (6, 'Admin6', 'admin6', 'password6'),
    (7, 'Admin7', 'admin7', 'password7');
GO
...
CREATE LOGIN UserWithFullAccess WITH PASSWORD = 'StrongPassword123';
...
CREATE LOGIN UserWithReadOnlyAccess WITH PASSWORD = 'StrongPassword456';
...
--3. Добавить второго пользователя только для просмотра всех таблиц:


--сохранить файл
--написать отчет
--написать преподу
--прикрепить все в гитхаб
--создать еще один гит аккаунт чтобы быть скрытным